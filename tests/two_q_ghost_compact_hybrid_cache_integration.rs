...
//! Integration tests for the `two_q_ghost_compact_hybrid_cache` feature.
//!
...
mod hybrid_cache_tests {
    ...
    fn ensure_pmem_allocator_warm() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(1_048_576, CacheTierSize::Bytes(1_048_576), PaperPolicy::TwoQGhostCompactHybrid(1.0))
    ...
    fn admission_always_lands_in_slow_tier() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            1_048_576,
            CacheTierSize::Bytes(1_048_576), PaperPolicy::TwoQGhostCompactHybrid(1.0)).expect("cache should construct");
    ...
    fn a_key_that_ages_out_and_is_readmitted_lands_directly_in_fast_tier() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(1_048_576, CacheTierSize::Bytes(1_048_576), PaperPolicy::TwoQGhostCompactHybrid(0.00002)).expect("cache should construct");
    ...
    fn fast_tier_pressure_within_main_queue_demotes_lru_tail() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            ...
            CacheTierSize::Bytes(1_600), PaperPolicy::TwoQGhostCompactHybrid(1.0)).expect("cache should construct");
    ...
    fn ttl_survives_a_demotion() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            1_048_576,
            CacheTierSize::Bytes(TTL_FAST_TIER), PaperPolicy::TwoQGhostCompactHybrid(1.0)).expect("cache should construct");
    ...
    fn terminal_eviction_prefers_fifo_queue_over_main_queue() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            256,
            CacheTierSize::Bytes(256), PaperPolicy::TwoQGhostCompactHybrid(1.0)).expect("cache should construct");
    ...
    fn zero_fast_tier_size_is_rejected() {
        let result = PaperCache::<u32, TieredBuffer>::new(1_024, CacheTierSize::Bytes(0), PaperPolicy::TwoQGhostCompactHybrid(0.5));
    ...
    fn invalid_k_in_is_rejected() {
        assert!(matches!(
            PaperCache::<u32, TieredBuffer>::new(1_024, CacheTierSize::Bytes(512), PaperPolicy::TwoQGhostCompactHybrid(1.5)),
