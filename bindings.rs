...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of nodemask_t"][::std::mem::size_of::<nodemask_t>() - 16usize];
    ["Alignment of nodemask_t"][::std::mem::align_of::<nodemask_t>() - 8usize];
    ["Offset of field: nodemask_t::n"][::std::mem::offset_of!(nodemask_t, n) - 0usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct bitmask {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of bitmask"][::std::mem::size_of::<bitmask>() - 16usize];
    ["Alignment of bitmask"][::std::mem::align_of::<bitmask>() - 8usize];
    ["Offset of field: bitmask::size"][::std::mem::offset_of!(bitmask, size) - 0usize];
    ["Offset of field: bitmask::maskp"][::std::mem::offset_of!(bitmask, maskp) - 8usize];
};
unsafe extern "C" {
