...
//! `s3_fifo_ghost_lazy_demotion_fast_admission_compact_hybrid_cache` feature.
//!
//! Run with nightly (required for `allocator_api` via `key_value_pmem`):
//!   cargo +nightly test --test s3_fifo_ghost_lazy_demotion_fast_admission_compact_hybrid_cache_integration --features s3_fifo_ghost_lazy_demotion_fast_admission_compact_hybrid_cache
//!
...
#[cfg(feature = "s3_fifo_ghost_lazy_demotion_fast_admission_compact_hybrid_cache")]
mod hybrid_cache_tests {
    ...
    fn ensure_pmem_allocator_warm() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(1_048_576, CacheTierSize::Bytes(1_024), PaperPolicy::S3FifoGhostLazyDemotionFastAdmissionCompactHybrid(0.001))
    ...
    fn admission_always_lands_in_fast_tier() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            1_048_576,
            CacheTierSize::Bytes(1_048_576), PaperPolicy::S3FifoGhostLazyDemotionFastAdmissionCompactHybrid(ONE_ACCESS_RATIO)).expect("cache should construct");
    ...
    fn reaccessing_a_one_access_key_stays_fast_without_a_counted_promotion() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            1_048_576,
            CacheTierSize::Bytes(1_048_576), PaperPolicy::S3FifoGhostLazyDemotionFastAdmissionCompactHybrid(0.5)).expect("cache should construct");
    ...
    fn a_key_that_ages_out_and_is_readmitted_lands_directly_in_main_queue() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(1_048_576, CacheTierSize::Bytes(1_048_576), PaperPolicy::S3FifoGhostLazyDemotionFastAdmissionCompactHybrid(0.00002)).expect("cache should construct");
    ...
    fn an_accessed_key_at_the_main_queue_tail_gets_a_second_chance_instead_of_eviction() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            1_048_576,
            CacheTierSize::Bytes(KB_FAST_TIER + KB_ONE_ACCESS_RESERVE), PaperPolicy::S3FifoGhostLazyDemotionFastAdmissionCompactHybrid(KB_ONE_ACCESS_RATIO)).expect("cache should construct");
    ...
    fn one_access_ratio_can_reserve_the_entire_fast_budget_forcing_immediate_demotion() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            1_048_576,
            CacheTierSize::Bytes(100), PaperPolicy::S3FifoGhostLazyDemotionFastAdmissionCompactHybrid(0.0001)).expect("cache should construct");
    ...
    fn ttl_survives_a_demotion() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            1_048_576,
            CacheTierSize::Bytes(TTL_FAST_TIER + KB_ONE_ACCESS_RESERVE), PaperPolicy::S3FifoGhostLazyDemotionFastAdmissionCompactHybrid(KB_ONE_ACCESS_RATIO)).expect("cache should construct");
    ...
    fn terminal_eviction_prefers_one_access_queue_over_main_queue() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            MAX_SIZE,
            CacheTierSize::Bytes(400), PaperPolicy::S3FifoGhostLazyDemotionFastAdmissionCompactHybrid(0.4)).expect("cache should construct");
    ...
    fn zero_fast_tier_size_is_rejected() {
        let result = PaperCache::<u32, TieredBuffer>::new(1_024, CacheTierSize::Bytes(0), PaperPolicy::S3FifoGhostLazyDemotionFastAdmissionCompactHybrid(0.5));
    ...
    fn invalid_one_access_ratio_is_rejected() {
        assert!(matches!(
            PaperCache::<u32, TieredBuffer>::new(1_024, CacheTierSize::Bytes(512), PaperPolicy::S3FifoGhostLazyDemotionFastAdmissionCompactHybrid(1.5)),
