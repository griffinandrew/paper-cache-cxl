...
//!   cargo +nightly test --test s3_fifo_lazy_demotion_fast_admission_midpoint_reprieve_hybrid_cache_integration --features s3_fifo_lazy_demotion_fast_admission_midpoint_reprieve_hybrid_cache
//!
...
mod hybrid_cache_tests {
    ...
    fn ensure_pmem_allocator_warm() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(1_048_576, CacheTierSize::Bytes(1), PaperPolicy::S3FifoLazyDemotionFastAdmissionMidpointReprieveHybrid(NO_ONE_ACCESS_RATIO))
    ...
    fn admission_always_lands_in_fast_tier() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            1_048_576,
            CacheTierSize::Bytes(1_048_576), PaperPolicy::S3FifoLazyDemotionFastAdmissionMidpointReprieveHybrid(0.5)).expect("cache should construct");
    ...
    fn one_access_pressure_alone_never_causes_a_terminal_eviction() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            1_048_576,
            CacheTierSize::Bytes(1_048_576), PaperPolicy::S3FifoLazyDemotionFastAdmissionMidpointReprieveHybrid(0.00004)).expect("cache should construct");
    ...
    fn set_fast_tier_size_takes_effect_at_runtime() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            1_048_576,
            CacheTierSize::Bytes(1_048_576), PaperPolicy::S3FifoLazyDemotionFastAdmissionMidpointReprieveHybrid(NO_ONE_ACCESS_RATIO)).expect("cache should construct");
    ...
    fn zero_fast_tier_size_is_rejected() {
        let result = PaperCache::<u32, TieredBuffer>::new(1_024, CacheTierSize::Bytes(0), PaperPolicy::S3FifoLazyDemotionFastAdmissionMidpointReprieveHybrid(0.5));
    ...
    fn invalid_one_access_ratio_is_rejected() {
        assert!(matches!(
            PaperCache::<u32, TieredBuffer>::new(1_024, CacheTierSize::Bytes(512), PaperPolicy::S3FifoLazyDemotionFastAdmissionMidpointReprieveHybrid(1.5)),
