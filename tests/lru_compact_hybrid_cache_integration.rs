...
//! Integration tests for the `lru_compact_hybrid_cache` feature.
//!
...
mod hybrid_cache_tests {
    ...
    fn cascading_demotion_on_promotion_is_handled() {
        ...
        // one migration per call" path (`LruCompactHybridStack::settle_fast_tier`'s
    ...
    fn fast_tier_value_pressure_demotes_without_evicting() {
        ...
        // per-process binary tests/lru_compact_hybrid_cache_shared_overhead.rs.
        let cache = PaperCache::<u32, TieredBuffer>::new(
            1_048_576,
            CacheTierSize::Bytes(2_048), PaperPolicy::LruCompactHybrid).expect("cache should construct");
    ...
    ///     --test lru_compact_hybrid_cache_integration --features lru_compact_hybrid_cache \
    ...
    fn repro_real_dram_usage_at_scale() {
        ...
        let cache = PaperCache::<u64, TieredBuffer>::new(
            ...
            CacheTierSize::Gib(FAST_TIER_GIB), PaperPolicy::LruCompactHybrid).expect("cache should construct");
    ...
    fn concurrent_set_from_multiple_threads_still_demotes() {
        ...
        let cache = std::sync::Arc::new(
            PaperCache::<u64, TieredBuffer>::new(24 * 1_073_741_824, CacheTierSize::Gib(1), PaperPolicy::LruCompactHybrid)
