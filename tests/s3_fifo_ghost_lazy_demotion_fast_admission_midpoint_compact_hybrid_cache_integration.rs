...
//!   cargo +nightly test --test s3_fifo_ghost_lazy_demotion_fast_admission_midpoint_compact_hybrid_cache_integration --features s3_fifo_ghost_lazy_demotion_fast_admission_midpoint_compact_hybrid_cache
//!
...
//! `s3_fifo_ghost_lazy_demotion_fast_admission_compact_hybrid_cache` — see that
...
#[cfg(feature = "s3_fifo_ghost_lazy_demotion_fast_admission_midpoint_compact_hybrid_cache")]
mod hybrid_cache_tests {
    ...
    fn ensure_pmem_allocator_warm() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(1_048_576, CacheTierSize::Bytes(1_024), PaperPolicy::S3FifoGhostLazyDemotionFastAdmissionMidpointCompactHybrid(0.001))
    ...
    fn admission_always_lands_in_fast_tier() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            1_048_576,
            CacheTierSize::Bytes(1_048_576), PaperPolicy::S3FifoGhostLazyDemotionFastAdmissionMidpointCompactHybrid(ONE_ACCESS_RATIO)).expect("cache should construct");
    ...
    fn a_key_that_ages_out_and_is_readmitted_lands_directly_in_main_queue() {
        ...
        // main queue.
        let cache = PaperCache::<u32, TieredBuffer>::new(1_048_576, CacheTierSize::Bytes(1_048_576), PaperPolicy::S3FifoGhostLazyDemotionFastAdmissionMidpointCompactHybrid(0.00002)).expect("cache should construct");
    ...
    fn a_plain_access_on_a_fast_main_queue_key_does_not_migrate_or_reorder() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            1_048_576,
            CacheTierSize::Bytes(1_048_576), PaperPolicy::S3FifoGhostLazyDemotionFastAdmissionMidpointCompactHybrid(0.5)).expect("cache should construct");
    ...
    fn an_accessed_key_at_the_main_queue_tail_gets_a_second_chance_instead_of_eviction() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            1_048_576,
            CacheTierSize::Bytes(1_600 + ONE_ACCESS_RESERVE), PaperPolicy::S3FifoGhostLazyDemotionFastAdmissionMidpointCompactHybrid(ONE_ACCESS_RATIO)).expect("cache should construct");
    ...
    fn a_reaccessed_key_deep_in_the_slow_segment_survives_via_the_midpoint_checkpoint() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            2_048,
            CacheTierSize::Bytes(470), PaperPolicy::S3FifoGhostLazyDemotionFastAdmissionMidpointCompactHybrid(0.2)).expect("cache should construct");
    ...
    fn ttl_survives_a_demotion() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            1_048_576,
            CacheTierSize::Bytes(TTL_FAST_TIER + ONE_ACCESS_RESERVE), PaperPolicy::S3FifoGhostLazyDemotionFastAdmissionMidpointCompactHybrid(ONE_ACCESS_RATIO)).expect("cache should construct");
    ...
    fn terminal_eviction_prefers_one_access_queue_over_main_queue() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            MAX_SIZE,
            CacheTierSize::Bytes(400), PaperPolicy::S3FifoGhostLazyDemotionFastAdmissionMidpointCompactHybrid(0.4)).expect("cache should construct");
    ...
    fn zero_fast_tier_size_is_rejected() {
        let result = PaperCache::<u32, TieredBuffer>::new(1_024, CacheTierSize::Bytes(0), PaperPolicy::S3FifoGhostLazyDemotionFastAdmissionMidpointCompactHybrid(0.5));
    ...
    fn invalid_one_access_ratio_is_rejected() {
        assert!(matches!(
            PaperCache::<u32, TieredBuffer>::new(1_024, CacheTierSize::Bytes(512), PaperPolicy::S3FifoGhostLazyDemotionFastAdmissionMidpointCompactHybrid(1.5)),
