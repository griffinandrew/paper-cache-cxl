...
mod hybrid_cache_tests {
    ...
    fn a_key_that_ages_out_and_is_readmitted_lands_directly_in_fast_tier() {
        ...
        // is ever re-accessed.
        let cache = PaperCache::<u32, TieredBuffer>::new(1_048_576, CacheTierSize::Bytes(1_048_576), PaperPolicy::TwoQGhostCompactHybrid(0.00004)).expect("cache should construct");
    ...
    fn fast_tier_pressure_within_main_queue_demotes_lru_tail() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            1_048_576,
            CacheTierSize::Bytes(40), PaperPolicy::TwoQGhostCompactHybrid(1.0)).expect("cache should construct");
