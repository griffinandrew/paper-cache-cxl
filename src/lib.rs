...
#[cfg(any(feature = "key_value_pmem", feature = "alloc_api_exp", feature = "global_hashtable_pmem", feature = "tiering_hashtable_pmem", feature = "flatmap_pmem", feature = "global_flatmap_pmem"))]
pub mod allocator;
...
// This impl block uses RwLock patterns for all object accesses
#[cfg(all(feature = "flatmap_hash_and_object_tiering", feature = "key_value_pmem", feature = "enable_tiering_manager"))]
impl<K, S> PaperCache<K, BufferPMEM, S>
where
    K: 'static + Eq + Hash + TypeSize + std::fmt::Debug + Clone + Default, //note added Debug for logging might impact perf thoooo
    S: Default + Clone + BuildHasher,
{
	/// Creates an empty `PaperCache` with maximum size `max_size` and
	/// eviction policy `policy`. If the maximum size is zero, a
...
#[cfg(all(feature = "global_flatmap_pmem", not(feature = "key_value_pmem"), not(feature = "alloc_api_exp"), not(feature = "global_hashtable_pmem")))]
impl<K, S> PaperCache<K, BufferDRAM, S>
where
