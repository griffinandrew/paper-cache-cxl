...
#[cfg(all(feature = "key_value_pmem", not(feature = "global_hashtable_pmem"), not(feature = "flatmap_hash_and_object_tiering")))]
...
// FlatMap-specific implementation for flatmap_hash_and_object_tiering feature
