...
//! Integration tests for the `two_q_compact_hybrid_cache` feature.
//!
...
#[cfg(feature = "two_q_compact_hybrid_cache")]
mod hybrid_cache_tests {
    ...
    fn ensure_pmem_allocator_warm() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(1_048_576, CacheTierSize::Bytes(1_048_576), PaperPolicy::TwoQCompactHybrid(1.0))
    ...
    fn admission_always_lands_in_slow_tier() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            1_048_576,
            CacheTierSize::Bytes(1_048_576), PaperPolicy::TwoQCompactHybrid(1.0)).expect("cache should construct");
    ...
    fn fifo_key_aging_out_without_reaccess_is_evicted() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            256,
            CacheTierSize::Bytes(256), PaperPolicy::TwoQCompactHybrid(1.0)).expect("cache should construct");
    ...
    fn fifo_capacity_pressure_evicts_before_global_max_size_is_reached() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            ...
            CacheTierSize::Bytes(1_048_576), PaperPolicy::TwoQCompactHybrid(0.00002)).expect("cache should construct");
    ...
    fn fast_tier_pressure_within_main_queue_demotes_lru_tail() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            ...
            CacheTierSize::Bytes(1_600), PaperPolicy::TwoQCompactHybrid(1.0)).expect("cache should construct");
    ...
    fn ttl_survives_a_demotion() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            1_048_576,
            CacheTierSize::Bytes(TTL_FAST_TIER), PaperPolicy::TwoQCompactHybrid(1.0)).expect("cache should construct");
    ...
    fn resize_rescales_fifo_capacity() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(1_024, CacheTierSize::Bytes(1_024), PaperPolicy::TwoQCompactHybrid(0.5))
    ...
    fn zero_fast_tier_size_is_rejected() {
        let result = PaperCache::<u32, TieredBuffer>::new(1_024, CacheTierSize::Bytes(0), PaperPolicy::TwoQCompactHybrid(0.5));
        assert!(matches!(result, Err(CacheError::InvalidFastTierSize)));
    }

    #[test]
    fn fast_tier_size_exceeding_max_size_is_rejected() {
        let result = PaperCache::<u32, TieredBuffer>::new(1_024, CacheTierSize::Bytes(2_048), PaperPolicy::TwoQCompactHybrid(0.5));
        assert!(matches!(result, Err(CacheError::InvalidFastTierSize)));
    }

    #[test]
    fn zero_max_size_is_rejected() {
        let result = PaperCache::<u32, TieredBuffer>::new(0, CacheTierSize::Bytes(100), PaperPolicy::TwoQCompactHybrid(0.5));
    ...
    fn invalid_k_in_is_rejected() {
        assert!(matches!(
            PaperCache::<u32, TieredBuffer>::new(1_024, CacheTierSize::Bytes(512), PaperPolicy::TwoQCompactHybrid(1.5)),
            Err(CacheError::InvalidPolicy),
        ));

        assert!(matches!(
            PaperCache::<u32, TieredBuffer>::new(1_024, CacheTierSize::Bytes(512), PaperPolicy::TwoQCompactHybrid(-0.1)),
            Err(CacheError::InvalidPolicy),
        ));
    }
    ...
    fn tiny_fast_tier_still_allows_fifo_admission() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            1_048_576,
            CacheTierSize::Bytes(1), PaperPolicy::TwoQCompactHybrid(1.0)).expect("cache should construct");
