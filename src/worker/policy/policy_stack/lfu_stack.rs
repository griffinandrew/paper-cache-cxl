...
#[cfg(feature = "eviction_stacks_pmem")]
use super::pmem_collections::{PmemHashList, PmemIndex, PmemVecList};
...
impl PolicyStack for LfuStack {
    ...
    fn update(&mut self, key: HashedKey) {
        ...
        if let Some(next_count_stack_index) =
            self.count_stacks.get_next_index(prev_count_stack_index)
        {
