...
//!   cargo +nightly test --test hybrid_cache_integration --features s3_fifo_lazy_demotion_fast_admission_reprieve_hybrid_cache
//!
...
mod hybrid_cache_tests {
    ...
    fn ensure_pmem_allocator_warm() {
        let cache = PaperCache::<u32, TieredBuffer>::new(1_000_000, CacheTierSize::Bytes(1), PaperPolicy::S3FifoLazyDemotionFastAdmissionReprieveHybrid(0.0))
    ...
    fn admission_always_lands_in_fast_tier() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            1_000_000,
            CacheTierSize::Bytes(1_000_000), PaperPolicy::S3FifoLazyDemotionFastAdmissionReprieveHybrid(1.0)).expect("cache should construct");
    ...
    fn a_key_that_ages_out_lands_directly_in_the_main_queues_slow_tier() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(1_000_000, CacheTierSize::Bytes(1_000_000), PaperPolicy::S3FifoLazyDemotionFastAdmissionReprieveHybrid(0.00004)).expect("cache should construct");
    ...
    fn a_reprieved_key_can_be_promoted_by_a_later_access() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            1_000_000,
            CacheTierSize::Bytes(1_000_000), PaperPolicy::S3FifoLazyDemotionFastAdmissionReprieveHybrid(0.00004)).expect("cache should construct");
    ...
    fn a_plain_access_on_a_fast_main_queue_key_does_not_migrate_or_reorder() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            1_000_000,
            CacheTierSize::Bytes(1_000_000), PaperPolicy::S3FifoLazyDemotionFastAdmissionReprieveHybrid(0.5)).expect("cache should construct");
    ...
    fn ttl_survives_a_demotion() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            1_000_000,
            CacheTierSize::Bytes(TTL_FAST_TIER), PaperPolicy::S3FifoLazyDemotionFastAdmissionReprieveHybrid(0.0)).expect("cache should construct");
    ...
    fn set_fast_tier_size_takes_effect_at_runtime() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            1_000_000,
            CacheTierSize::Bytes(1_000_000), PaperPolicy::S3FifoLazyDemotionFastAdmissionReprieveHybrid(0.0)).expect("cache should construct");
    ...
    fn zero_fast_tier_size_is_rejected() {
        let result = PaperCache::<u32, TieredBuffer>::new(1_000, CacheTierSize::Bytes(0), PaperPolicy::S3FifoLazyDemotionFastAdmissionReprieveHybrid(0.5));
    ...
    fn invalid_one_access_ratio_is_rejected() {
        assert!(matches!(
            PaperCache::<u32, TieredBuffer>::new(1_000, CacheTierSize::Bytes(500), PaperPolicy::S3FifoLazyDemotionFastAdmissionReprieveHybrid(1.5)),
