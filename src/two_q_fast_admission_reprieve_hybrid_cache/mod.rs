...
/// Marker type selecting `two_q_fast_admission_reprieve_hybrid_cache`'s behavior for
...
pub struct TwoQFastAdmissionReprieveHybridPolicy;

impl crate::hybrid_policy::HybridPolicy for TwoQFastAdmissionReprieveHybridPolicy {
	type Stats = TwoQFastAdmissionReprieveHybridStats;
	type ExtraConfig = f64;

	fn seed_policy(k_in: f64) -> crate::PaperPolicy {
		crate::PaperPolicy::TwoQFastAdmissionReprieveHybrid(k_in)
	}
