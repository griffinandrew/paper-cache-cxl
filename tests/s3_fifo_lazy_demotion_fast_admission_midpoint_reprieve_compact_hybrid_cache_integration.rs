...
//!   cargo +nightly test --test s3_fifo_lazy_demotion_fast_admission_midpoint_reprieve_compact_hybrid_cache_integration --features s3_fifo_lazy_demotion_fast_admission_midpoint_reprieve_compact_hybrid_cache
//!
...
#[cfg(feature = "s3_fifo_lazy_demotion_fast_admission_midpoint_reprieve_compact_hybrid_cache")]
mod hybrid_cache_tests {
    ...
    fn ensure_pmem_allocator_warm() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(1_048_576, CacheTierSize::Bytes(1), PaperPolicy::S3FifoLazyDemotionFastAdmissionMidpointReprieveCompactHybrid(NO_ONE_ACCESS_RATIO))
    ...
    fn admission_always_lands_in_fast_tier() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            1_048_576,
            CacheTierSize::Bytes(1_048_576), PaperPolicy::S3FifoLazyDemotionFastAdmissionMidpointReprieveCompactHybrid(0.5)).expect("cache should construct");
    ...
    fn a_key_that_ages_out_lands_directly_in_the_main_queues_slow_tier() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(1_048_576, CacheTierSize::Bytes(1_048_576), PaperPolicy::S3FifoLazyDemotionFastAdmissionMidpointReprieveCompactHybrid(0.00004)).expect("cache should construct");
    ...
    fn a_reprieved_key_can_be_promoted_by_a_later_access() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            4_096,
            CacheTierSize::Bytes(4_096), PaperPolicy::S3FifoLazyDemotionFastAdmissionMidpointReprieveCompactHybrid(0.01)).expect("cache should construct");
    ...
    fn one_access_pressure_alone_never_causes_a_terminal_eviction() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            1_048_576,
            CacheTierSize::Bytes(1_048_576), PaperPolicy::S3FifoLazyDemotionFastAdmissionMidpointReprieveCompactHybrid(0.00004)).expect("cache should construct");
    ...
    fn an_accessed_key_at_the_main_queue_tail_gets_a_second_chance_instead_of_eviction() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            4_096,
            CacheTierSize::Bytes(80), PaperPolicy::S3FifoLazyDemotionFastAdmissionMidpointReprieveCompactHybrid(0.01)).expect("cache should construct");
    ...
    fn an_accessed_fast_boundary_key_is_reprieved_at_demotion_time_instead_of_the_newcomer() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            1_048_576,
            CacheTierSize::Bytes(80), PaperPolicy::S3FifoLazyDemotionFastAdmissionMidpointReprieveCompactHybrid(0.00004)).expect("cache should construct");
    ...
    fn a_reaccessed_key_deep_in_the_slow_segment_survives_via_the_midpoint_checkpoint() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            2_048,
            CacheTierSize::Bytes(470), PaperPolicy::S3FifoLazyDemotionFastAdmissionMidpointReprieveCompactHybrid(0.2)).expect("cache should construct");
    ...
    fn ttl_survives_a_demotion() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            1_048_576,
            CacheTierSize::Bytes(TTL_FAST_TIER), PaperPolicy::S3FifoLazyDemotionFastAdmissionMidpointReprieveCompactHybrid(NO_ONE_ACCESS_RATIO)).expect("cache should construct");
    ...
    fn set_fast_tier_size_takes_effect_at_runtime() {
        ...
        let cache = PaperCache::<u32, TieredBuffer>::new(
            1_048_576,
            CacheTierSize::Bytes(1_048_576), PaperPolicy::S3FifoLazyDemotionFastAdmissionMidpointReprieveCompactHybrid(NO_ONE_ACCESS_RATIO)).expect("cache should construct");
    ...
    fn zero_fast_tier_size_is_rejected() {
        let result = PaperCache::<u32, TieredBuffer>::new(1_024, CacheTierSize::Bytes(0), PaperPolicy::S3FifoLazyDemotionFastAdmissionMidpointReprieveCompactHybrid(0.5));
    ...
    fn invalid_one_access_ratio_is_rejected() {
        assert!(matches!(
            PaperCache::<u32, TieredBuffer>::new(1_024, CacheTierSize::Bytes(512), PaperPolicy::S3FifoLazyDemotionFastAdmissionMidpointReprieveCompactHybrid(1.5)),
    ...
    fn concurrent_sets_are_never_clobbered_by_an_in_flight_migration() {
        ...
        let cache = std::sync::Arc::new(
            PaperCache::<u32, TieredBuffer>::new(
                256 * 1024 * 1024,
                CacheTierSize::Bytes(16 * 1024 * 1024), PaperPolicy::S3FifoLazyDemotionFastAdmissionMidpointReprieveCompactHybrid(0.004)).expect("cache should construct"),
        );
